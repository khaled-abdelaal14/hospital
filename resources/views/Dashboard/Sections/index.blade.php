                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example2">
                                            <thead>
                                            <tr>
                                                <th class="col-3 border-bottom-0">#</th>
                                                <th class="col-3 border-bottom-0">{{trans('Dashboard/sections_trans.name_sections')}}</th>
                                                <th class="col-3 border-bottom-0">{{trans('Dashboard/sections_trans.description')}}</th>
                                                <th class="col-3 border-bottom-0">{{trans('Dashboard/sections_trans.created_at')}}</th>
                                                <th class="col-3 border-bottom-0">{{trans('Dashboard/sections_trans.Processes')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
