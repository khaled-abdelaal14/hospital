...
use App\Repository\Doctors\DoctorRepositry;
...
use App\Repository\Sections\SectionRepositry;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind(SectionRepositoryInterface::class, SectionRepositry::class);
        $this->app->bind(DoctorRepositryInterface::class, DoctorRepositry::class);
